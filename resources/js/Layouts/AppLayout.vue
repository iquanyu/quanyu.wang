<template>
  <div>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 xl:max-w-5xl xl:px-0 py-4">
      <header class="flex justify-between items-center h-16">
        <div>
          <Link :href="route('home')">
          <!-- <jet-application-logo class="block h-9 w-auto" /> -->
          <h2 class=" font-semibold text-3xl text-orange-600">Quanyu</h2>
          </Link>
        </div>
        ...
        <!-- <div class="text-base leading-5">
          <a href="https://tailwindcss.com/docs"
             class="font-medium text-gray-500 hover:text-gray-700">Documentation →</a>
        </div> -->
      </header>
